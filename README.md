...
3. Activar opciones avanzadas del site
4. Activar Guest y poner site personalizado ip de servidor de site si utilizas https es importante tener el certificado apache ssl si no no funccionara ademas de usuario ssl en el ubinquiti
5 . añadir dentro de la opciones de red la opcion de incio sin contraseña y guest .
-

Instalacion de la api 
-

REQ > PHP se necesita composer 
